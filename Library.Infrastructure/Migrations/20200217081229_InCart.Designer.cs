...
namespace Library.Infrastructure.Migrations
{
    ...
    [Migration("20200217081229_InCart")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.Domain.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Library.Domain.BookCopy", b =>
                {
                    ...
                    b.HasOne("Library.Domain.ShoppingCart", null)
                        .WithMany("Copies")
            ...
            modelBuilder.Entity("Library.Domain.Member", b =>
                {
                    b.HasOne("Library.Domain.ShoppingCart", "ShoppingCart")
                        .WithMany()
                        .HasForeignKey("ShoppingCartId");
                });
